  ...
  <div class="container-scroller">
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
          <a class="navbar-brand brand-logo" href="offreattente.html">
            <img src="images/logojob.png" alt="logo" />
          </a>
          <a class="navbar-brand brand-logo-mini" href="offreattente.html">
            <img src="" alt="">
          </a>
        </div>
      </div>
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              <img class="img-xs rounded-circle"  src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg">
             </a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="offreattente.html">
              <i class="menu-icon mdi mdi-table"></i>
              <span class="menu-title">Offres En Attente</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="recommandation.html">
                            ...
                            <div class="row">
                                        ...
                                        <h4 class="text-align"> <u>A Propos De Vous </u> </h4>
                                         ...
                                         src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg">
                                             ...
                                             <span class="font-weight-bold">AKP Djemi</span>
                                              <span class="text-black-50">Djemidjemi@mail.com</span></div>
                                ...
                                <div class="col-md-5 border-right">
                                        ...
                                        <div class="row mt-3" style="">
                                            ...
                                            <div class="col-md-12"> <p></p> <label class="labels"> Sexe</label> 
                                            ...
                                            <div class="col-md-12"><label class="labels">Diplomes</label><input type="text"
                                                class="form-control" placeholder="Entrer Vos Diplomes" value=""></div>
                                    ...
                                    <div class="p-3 py-5">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <h4 class="text-align"> <u>Compétences </u> </h4> <br>
