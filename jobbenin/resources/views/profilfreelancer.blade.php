          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                ...
                <a class="dropdown-item" href=" {{('profilfreelancer')}}">    <i class="mdi mdi-account menu-icon"></i> Mon Profil</a>
          ...
          <div class="contact-form">
            ...
            <form method="POST" action="{{ route('user.update', $user->id) }}" enctype="multipart/form-data" style="max-width: 400px; margin: 0 auto;">
              ...
              <div class="form-group">
                ...
                <textarea class="wysiwyg form-textarea " required="required" name="description_free" cols="14" rows="6">{{$user->description_free}}</textarea>
              ...
              <div class="form-group">
                <div style="text-align: center;">
                  <button type="submit" class="btn btn-primary" style="background-color: #242b5e; border-color: #242b5e; padding: 0.5em 1em; 
