    ...
    <p>
      <button class="button1" data-modal="modal-mod">Modifier vos informations</button>
         ...
         <div class="information">
          ...
          <h5>Porto-Novo</h5> <br>
          <h4>Email</h4>
          <h5>creative@gmail.com</h5><br>
          <h4>Description</h4>
          <h5 style="width: 200px;height:100px;">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur, magni commodi. Libero dicta harum voluptatum autem soluta ullam, facilis corrupti expedita cupiditate! Illum, maxime! Facilis, repellat? Doloribus esse eaque ea.</h5>
      ...
      <div class="modal1-content">
        <div class="contact-form">
          ...
          <form action="" method="" class="form1">
            ...
            <div>
              <input class="fname" type="text" name="name" placeholder="Nom de votre Entreprise" />
              <input class="fname" type="text" name="name" placeholder="Ville" />
              <input class="fname" type="text" name="name" placeholder="Email" />
            </div>
            <span>Description</span>
            <div>
              <textarea class="fname" rows="4"></textarea>
            </div>
            <button type="" href="">Envoyer</button>
          </form>
        </div>
      </div>
    </div>
